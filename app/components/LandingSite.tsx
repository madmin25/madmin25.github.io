    ...
    <div className='hidden md:block relative border-0 border-green-300 mx-auto h-dvh'>
        <div className='fromLeft float-left border-02 border-green-300 h-[90%] flex w-[50%]'>
            <div className='border-0 border-red-40'>
                ...
                <div className='w-fit kanit-semibold text-3xl bg-[--accentColor] text-[--blackish] md:mt-16 lg:mt-20 xl:mt-28'><a href="mailto:martin.adelwarth@arcor.de"><div className='w-full h-full p-4'>CONTACT ME</div></a></div>
            </div>
        </div>
    ...
    <div className='block md:hidden relative border-0 border-orange-400 w-[100%]'>
        ...
        <div className='fromLeft border-0 border-green-300 h-[90%] ml-8 pr-10'>
            <div className='border-0 border-red-40'>
                ...
                <div className='w-fit kanit-semibold text-2xl bg-[--accentColor]  text-[--blackish] ml-auto mt-8'><a href="mailto:martin.adelwarth@arcor.de"><div className='p-3 h-full w-full'>CONTACT ME</div></a></div>
            </div>
        </div>
